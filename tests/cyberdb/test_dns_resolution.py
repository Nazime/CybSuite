def test_resolve_functions(new_cyberdb):
    ...
    assert set(new_cyberdb.resolve_ip("8.8.8.8")) == {"dns.google.com", "google-public-dns-a.google.com"}
    assert set(new_cyberdb.resolve_ip("1.1.1.1")) == set()  # Test non-existent IP

    # Test resolve_domain_name function
    assert set(new_cyberdb.resolve_domain_name("dns.google.com")) == {"8.8.8.8", "8.8.4.4"}
    assert set(new_cyberdb.resolve_domain_name("nonexistent.example.com")) == set()  # Test non-existent domain

    # Test resolve function
    # Test with IP address
    assert set(new_cyberdb.resolve("8.8.8.8")) == {"dns.google.com", "google-public-dns-a.google.com"}
